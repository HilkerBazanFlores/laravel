...
<html lang="en">
  <head>
    <title>Aplicación todolist con laravel</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    <meta
      name="viewport"
...
<br/>
<input type="button" class="btn btn-primary" value="Agregar tarea">
...
<div
  class="table-responsive-sm table-borderd table-striped"
>
  <table
    class="table"
  >
